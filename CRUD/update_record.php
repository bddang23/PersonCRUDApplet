...
$sql = "UPDATE persons SET email=?, fname=?, lname=?, phone=?, `address`=?, address2=?, city=?, `state`=?, zip_code=? WHERE id=?";
$query = $pdo->prepare($sql);
$query->execute(Array($email, $fname, $lname, $phone, $address, $address2, $city, $state, $zip_code ,$id));
